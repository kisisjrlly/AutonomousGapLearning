"""LEGACY NEGATIVE EXAMPLE: open-loop probe/hover/pitch schedule.

Retained only to reproduce the 2026-09-22 failure where a contact-free rollout
was incorrectly close to being described as recovered. It is not the current
recovery baseline; use agl.eval.closed_loop_probe instead.

This is an open-loop diagnostic, not a learned policy. It uses CTBR
